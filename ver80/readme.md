# Morse Code Encoder/Decoder, version 8

## About this version

- In this version of code, we will create a new WAV file, not pre-existing WAV files. 
- Morse code structure

## Details 

### 1. Morse code structure
...
### 2. Anatomy of WAV file format

- anatomy

  ```txt
  endian  file offset  field name     field size
...
- Terminology: header, RIFF, fmt, data, WAV, modulation, PCM, sample, byte rate, endian, chunk, channels

### 4. Sound to Digital Data
